...
class AnimationManager:
    ...
    def get_stage_html(self, stage_key: str, progress: float = 0, 
        ...
        # Animation keyframes based on type
        ...
        ">
            <div style="
                font-size: 3.5rem; 
                margin-bottom: 1rem;
                animation: {stage.animation_type} 2s ease-in-out infinite;
            ...
            ">
                ...
                <span style="
                    ...
                    border-radius: 50%; 
                    display: inline-block; 
                    animation: bounceDot 1.4s ease-in-out 0.2s infinite;
                "></span>
                <span style="
                    width: 10px; 
                    height: 10px; 
                    ...
                    border-radius: 50%; 
                    display: inline-block; 
                    animation: bounceDot 1.4s ease-in-out 0.4s infinite;
                "></span>
            </div>
            ...
            <div style="
                ...
                text-align: left;
            ">
                <div style="color: #81d4fa; font-size: 0.9rem; font-style: italic;">
                    {tip}
                </div>
            </div>
            ''' if tip and stage.show_tips else ''}
    ...
    def _get_metric_row(self, label: str, value: int, color: str) -> str:
        ...
        ">
            ...
            <div style="
                font-size: 1.25rem; 
                font-weight: 700; 
                color: {color if value >= 90 else '#94a3b8'};
            ">
                {value}%
            </div>
        </div>
